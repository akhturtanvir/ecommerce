...
<nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row navbar-info">
      ...
      <li class="nav-item dropdown d-none d-xl-inline-block user-dropdown">
        <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
          <div class="dropdown-toggle-wrapper">
            ...
            <div class="inner">
              <div class="inner">
                <span class="profile-text font-weight-bold"><?php echo(Session::get('name')); ?></span>
                <small class="profile-text small"><?php echo(Session::get('username')); ?></small>
              </div>
              <div class="inner">
        ...
        <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
          ...
          <a class="dropdown-item" href="?action=signout">
            Sign Out
          </a>
        </div>
      </li>
